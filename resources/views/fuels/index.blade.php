 <x-app-layout>
    ...
    <x-slot name="header">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <a href="#" class="btn btn-lg fs-5 btn-primary" data-bs-toggle="modal"
                data-bs-target="#createFuelModal">Brandstof model Toevoegen</a>
        </div>
    </x-slot>
                    ...
                    <div class="card">
                        <div class="card-header fs-3 d-flex justify-content-between">
                            ...
                            <div class="d-flex align-items-center">
                                <form action="{{ route('dashboard.fuels.search') }}" method="GET">
                                            ...
                                            @foreach ($fuels as $fuel)
                                                <tr>
                                                    ...
                                                    <td class="d-none d-md-table-cell">
                                                        {{ date('d-m-Y', strtotime($fuel->created_at)) }}</td>
                                                    <td class="d-none d-md-table-cell">
                                                        {{ date('d-m-Y', strtotime($fuel->updated_at)) }}</td>
                                                    <td class="text-end">
                                                    ...
                                                    <td class="text-start">
                                                        <form action="{{ route('dashboard.fuels.destroy', $fuel->id) }}"
    ...
    @include('fuels.modal.create')
    @include('fuels.modal.edit')
