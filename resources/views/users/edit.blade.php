                        ...
                        <div class="card-body">
                            <form action="{{ route('dashboard.users.update', ['user' => $user]) }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="mb-3 form-check">
                                    <input type="checkbox" class="form-check-input" id="isAdmin" name="isAdmin" value="1" {{ old('isAdmin', $user->isAdmin) == '1' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="isAdmin">Is Admin</label>
                                </div>
                            
                                <div class="mb-3">
                                    <label for="password" class="form-label">Wachtwoord (laat leeg als je het niet wilt wijzigen)</label>
                                ...
                                <div class="mb-3 d-flex justify-content-end">
                                    <a href="{{ route('dashboard.users.index') }}" class="btn-lg btn btn-link m-2">Terug</a>
                                    <input type="submit" class="btn-lg btn btn-primary m-2" value="Gebruiker Aanpassen">
                                </div>
                            </form>
