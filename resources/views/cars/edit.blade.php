                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content" id="myTabContent">
                                ...
                                <div class="tab-pane fade show active" id="general" role="tabpanel"
                                    ...
                                    <form action="{{ route('dashboard.cars.update', ['car' => $car]) }}" method="post"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text"
                                                ...
                                                name="title" value="{{ old('title', $car->title) }}">
                                            @error('title')
                                            ...
                                            <select class="form-control select2 @error('brand_id') is-invalid @enderror"
                                                ...
                                                @foreach ($brands as $brand)
                                                    <option value="{{ $brand->id }}"
                                                        {{ $brand->id == old('brand_id', $car->brand_id) ? 'selected' : '' }}>
                                                        {{ $brand->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                            ...
                                            <select class="form-control select2 @error('type_id') is-invalid @enderror"
                                                ...
                                                @foreach ($types as $type)
                                                    <option value="{{ $type->id }}"
                                                        {{ $type->id == old('type_id', $car->type_id) ? 'selected' : '' }}>
                                                        {{ $type->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control select2 @error('fuel_id') is-invalid @enderror"
                                                id="fuel_id" name="fuel_id">
                                                @foreach ($fuels as $fuel)
                                                    <option value="{{ $fuel->id }}"
                                                        {{ $fuel->id == old('fuel_id', $car->fuel_id) ? 'selected' : '' }}>
                                                        {{ $fuel->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="date"
                                                class="form-control @error('mot') is-invalid @enderror" id="mot"
                                                name="mot" value="{{ old('mot', $car->mot) }}">
                                            @error('mot')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                ...
                                <div class="tab-pane fade" id="specifications" role="tabpanel"
                                    ...
                                    <form method="POST"
                                        action="{{ route('dashboard.cars.saveSpecifications', $car) }}">
                                        @csrf
                                        @method('post')
                                        <div class="row">
                                ...
                                <div class="tab-pane fade" id="images" role="tabpanel"
                                    ...
                                    <form action="{{ route('dashboard.cars.images', ['car' => $car]) }}"
