<x-app-layout>
    ...
    <x-slot name="header">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <a href="#" class="btn btn-lg fs-5 btn-primary" data-bs-toggle="modal"
                data-bs-target="#createBrandModal">Merk Toevoegen</a>
        </div>
    </x-slot>
                    ...
                    <div class="card">
                        <div class="card-header fs-3 d-flex justify-content-between">
                            ...
                            <div class="d-flex align-items-center">
                                <form action="{{ route('dashboard.brands.search') }}" method="GET">
                                            ...
                                            @foreach ($brands as $brand)
                                                <tr>
                                                    ...
                                                    <td class="d-none d-md-table-cell">
                                                        {{ date('d-m-Y', strtotime($brand->created_at)) }}</td>
                                                    <td class="d-none d-md-table-cell">
                                                        {{ date('d-m-Y', strtotime($brand->updated_at)) }}</td>
                                                    <td class="text-end">
    ...
    @include('brands.modal.create')
    @include('brands.modal.edit')
