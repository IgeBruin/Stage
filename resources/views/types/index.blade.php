<x-app-layout>
    ...
    <x-slot name="header">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <a href="#" class="btn btn-lg fs-5 btn-primary" data-bs-toggle="modal"
                data-bs-target="#createTypeModal">Type model Toevoegen</a>
        </div>
    </x-slot>
                ...
                <div class="d-flex flex-column justify-content-start">
                    <div class="card">
                        <div class="card-header fs-3 d-flex justify-content-between">
                            <span>Type modellen</span>
                            <div class="d-flex align-items-center">
                                <form action="{{ route('dashboard.types.search') }}" method="GET">
                                            ...
                                            @foreach ($types as $type)
                                                <tr>
                                                    ...
                                                    <td class="d-none d-md-table-cell">
                                                        {{ date('d-m-Y', strtotime($type->created_at)) }}</td>
                                                    <td class="d-none d-md-table-cell">
                                                        {{ date('d-m-Y', strtotime($type->updated_at)) }}</td>
                                                    <td class="text-end">
    ...
    @include('types.modal.create')
    @include('types.modal.edit')
