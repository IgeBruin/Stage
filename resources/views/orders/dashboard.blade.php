                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    <thead>
                                        <tr>
                                            <th class="fs-5">Gebruiker</th>
                                            <th class="fs-5">E-mail</th>
                                    ...
                                    <tbody>
                                        @if (count($orders) > 0)
                                            @foreach ($orders as $order)
                                                <tr>
                                                    ...
                                                    <td class="d-none d-md-table-cell">
                                                        {{ date('d-m-Y', strtotime($order->updated_at)) }}</td>
                                                    <td class="text-end">
                                                        <a class="btn"
                                                            href="{{ route('dashboard.orders.edit', $order->id) }}"><svg
                                        ...
                                        @else
                                            <tr>
                                                <td colspan="4" class="text-center">Geen bestellingen gevonden.</td>
                                            </tr>
                                        @endif
                                    </tbody>
                                </table>
