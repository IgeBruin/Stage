<x-app-layout>
    ...
    <x-slot name="header">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <a href="{{ route('dashboard.projects.create') }}" class="btn btn-lg fs-5 btn-primary">Project Aanmaken</a>
        </div>
    </x-slot>
                                ...
                                <table class="table table-striped">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="d-none d-md-table-cell fs-5">Startdatum</th>
                                            <th></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                            ...
                                            @foreach ($projects as $project)
                                                <tr>
                                                    ...
                                                    <td class="d-none d-md-table-cell">
                                                        {{ date('d-m-Y', strtotime($project->start_date)) }}</td>
                                                    <td class="text-end">
                                                        <a class="btn"
                                                            href="{{ route('dashboard.projects.edit', $project->id) }}"><svg
                                        ...
                                        @else
                                            <tr>
                                                <td colspan="4" class="text-center">Geen projecten gevonden.</td>
                                            </tr>
                                        @endif
                                    </tbody>
                                </table>
