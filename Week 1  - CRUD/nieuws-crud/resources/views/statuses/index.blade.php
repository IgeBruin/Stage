<x-app-layout>
    ...
    <x-slot name="header">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <a href="#" class="btn btn-lg fs-5 btn-primary" data-bs-toggle="modal"
                data-bs-target="#createStatusModal">Status Aanmaken</a>
        </div>
    </x-slot>
                    ...
                    <div class="card">
                        <div class="card-header fs-3 d-flex justify-content-between">
                            ...
                            <div class="d-flex align-items-center">
                                <form action="{{ route('dashboard.statuses.search') }}" method="GET">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                            ...
                                            @foreach ($statuses as $status)
                                                <tr>
                                                    ...
                                                    <td class="d-none d-md-table-cell">
                                                        {{ date('d-m-Y', strtotime($status->created_at)) }}</td>
                                                    <td class="d-none d-md-table-cell">
                                                        {{ date('d-m-Y', strtotime($status->updated_at)) }}</td>
                                                    <td class="text-end">
                                        ...
                                        @else
                                            <tr>
                                                <td colspan="4" class="text-center">Geen statussen gevonden.</td>
                                            </tr>
                                        @endif
                                    </tbody>
                                </table>
    ...
    @include('statuses.modal.create')
    @include('statuses.modal.edit')
